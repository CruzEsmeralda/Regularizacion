...
const validations =Yup.object().shape({
    cantidad:Yup.number().typeError('Este campo es solo numérico').max(99999999,"El Número es muy grande").required('Obligatorio'),
    precio:Yup.number().typeError('Este campo es solo numérico').max(99999999,"El Número es muy grande").required('Obligatorio'),
    descripcion: Yup.string().min(2,'La Descripción muy chica').max(50,'La Descripción muy Grande').required('Obligatorio')
})
